...
static void InitDefaultsscc_info_RespondMsg_RespondMsg_2eproto() {
  ...
  {
    void* ptr = &::respondMsg::_RespondMsg_default_instance_;
    new (ptr) ::respondMsg::RespondMsg();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::respondMsg::RespondMsg::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_RespondMsg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::respondMsg::RespondMsg, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::respondMsg::RespondMsg, rv_),
  PROTOBUF_FIELD_OFFSET(::respondMsg::RespondMsg, seckeyid_),
  PROTOBUF_FIELD_OFFSET(::respondMsg::RespondMsg, clientid_),
  PROTOBUF_FIELD_OFFSET(::respondMsg::RespondMsg, serverid_),
  PROTOBUF_FIELD_OFFSET(::respondMsg::RespondMsg, data_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::respondMsg::RespondMsg)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::respondMsg::_RespondMsg_default_instance_),
};

const char descriptor_table_protodef_RespondMsg_2eproto[] =
  "\n\020RespondMsg.proto\022\nrespondMsg\"\\\n\nRespon"
  "dMsg\022\n\n\002rv\030\001 \001(\005\022\020\n\010seckeyid\030\002 \001(\005\022\020\n\010cl"
  "ientId\030\003 \001(\t\022\020\n\010serverId\030\004 \001(\t\022\014\n\004data\030\005"
  " \001(\tb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_RespondMsg_2eproto = {
  &descriptor_table_RespondMsg_2eproto_initialized, descriptor_table_protodef_RespondMsg_2eproto, "RespondMsg.proto", 132,
...
RespondMsg::RespondMsg()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:respondMsg.RespondMsg)
}
RespondMsg::RespondMsg(const RespondMsg& from)
  ...
  // @@protoc_insertion_point(copy_constructor:respondMsg.RespondMsg)
}
...
RespondMsg::~RespondMsg() {
  // @@protoc_insertion_point(destructor:respondMsg.RespondMsg)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:respondMsg.RespondMsg)
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_clientid(), ptr, ctx, "respondMsg.RespondMsg.clientId");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string serverId = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_serverid(), ptr, ctx, "respondMsg.RespondMsg.serverId");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string data = 5;
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_data(), ptr, ctx, "respondMsg.RespondMsg.data");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:respondMsg.RespondMsg)
  for (;;) {
      ...
      case 3: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (26 & 0xFF)) {
          ...
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
            ...
            "respondMsg.RespondMsg.clientId"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 4: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (34 & 0xFF)) {
          ...
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE,
            "respondMsg.RespondMsg.serverId"));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:respondMsg.RespondMsg)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:respondMsg.RespondMsg)
  return false;
#undef DO_
}
...
void RespondMsg::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:respondMsg.RespondMsg)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:respondMsg.RespondMsg)
}

::PROTOBUF_NAMESPACE_ID::uint8* RespondMsg::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:respondMsg.RespondMsg)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:respondMsg.RespondMsg)
  return target;
}

size_t RespondMsg::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:respondMsg.RespondMsg)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:respondMsg.RespondMsg)
  GOOGLE_DCHECK_NE(&from, this);
  const RespondMsg* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RespondMsg>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:respondMsg.RespondMsg)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:respondMsg.RespondMsg)
    MergeFrom(*source);
  }
}

void RespondMsg::MergeFrom(const RespondMsg& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:respondMsg.RespondMsg)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:respondMsg.RespondMsg)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:respondMsg.RespondMsg)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::respondMsg::RespondMsg* Arena::CreateMaybeMessage< ::respondMsg::RespondMsg >(Arena* arena) {
  return Arena::CreateInternal< ::respondMsg::RespondMsg >(arena);
}
